...
const ListRoom = () => {
    ...
    return ( 
        ...
        <div>
            <Title align="left" font="outfit" title="List of Rooms" subTitle="Here is the list of rooms in your hotel." />
                                ...
                                <tr key={index}>
                                    ...
                                    text-sm text-red-500 text-center">
                                       ...
                                       text-gray-900 gap-3">
                                         ...
                                         peer-checked:bg-blue-600 transition-colors duration-500"></div>
