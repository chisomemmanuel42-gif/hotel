        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                    ...
                    {room?.images.length > 1 && room.images.map((image, index)=>(
                        ...
                        <img onClick={()=> setmainImage(image)}
                         key={index} src={image} alt="Room Image" className={`w-full 
                            rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && 'outline outline-3 outline-orange-500'}`}/>
                    ))}
                </div>
            </div>
            {/* Room Highlights */}
            <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                <div className='flex flex-col'>
                    <h1 className='text-3xl md:text-4xl font-playfair'>Expereince Luxury Like Never Before</h1>
            ...
            justify-between bg-white shadow-[0px_0px_2px_rgba(0,0,0,0.30)] p-6 
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guests will be allocated on the ground floor according to Availbility.
                    you get a comfortable Two bedroom apartment has a true feeling. The price 
                    quoted is for two guest,at the guest slot please mark the number pf the guest to get the exact 
                    price for the groups. The guests will be allocated ground floor according to Availbility
                    . You will get comfortable two bedroom apartment that has a true feeling.
                </p>
            </div>
